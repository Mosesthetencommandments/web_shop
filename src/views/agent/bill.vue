<template>
  <div class="app-container calendar-list-container">
    ...
    >
      ...
      <el-table-column align="center" label="提货时间" width="200">
        <template slot-scope="scope">
      ...
      <!-- <el-table-column prop="operation" label="操作" align="center">
        <template slot-scope="scope">
          <el-button type="success" size="mini" @click="yes(scope.row)">同意</el-button>
          <el-button type="danger" size="mini" @click="no(scope.row)">拒绝</el-button>
        </template>
      </el-table-column> -->
    </el-table>
    <!-- 分页 -->
